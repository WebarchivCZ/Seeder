    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(
                    ...
                    ), (b'VALID', 'Contract is valid'),
                             (b'EXPIRED', 'Contract expired')])),
                ('valid_from', models.DateField(null=True,
                                                blank=True)),
                ('valid_to', models.DateField(null=True,
                                              blank=True)),
                ('contract_file', models.FileField(null=True,
                                                   upload_to=b'contracts',
                                                   blank=True)),
                ('contract_type',
                 models.CharField(max_length=12,
                                  choices=[(b'CCOMMONS', 'Creative commons'),
                                           (b'PROPRIETARY', 'Proprietary')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduled_date',
                 models.DateField(verbose_name='When to send this message')),
