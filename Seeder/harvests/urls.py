...
urlpatterns = [
    ...
    path('<int:pk>/state', State.as_view(), name='state'),
    path('<int:pk>/run', Run.as_view(), name='run'),
    path('<int:pk>/pause', Pause.as_view(), name='pause'),
    path('<int:pk>/stop', State.as_view(), name='stop'),
    path('<int:pk>/teardown', TeardownJob.as_view(), name='teardown'),
